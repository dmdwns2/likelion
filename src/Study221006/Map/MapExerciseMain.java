...
public class MapExerciseMain {
    public static void main(String[] args) {
        // <Key , Value>  Key를 입력하면 Value가 출력된다.
        ...
        System.out.println(map.get("조성윤"));
        System.out.println(map.get("안예은"));
        System.out.println(map.get("남우빈"));
        System.out.println(map.get("최경민"));
        System.out.println(map.get("안준휘"));
        System.out.println(map.get("하채민"));
        System.out.println(map.get("허도한"));
        System.out.println(map.get("배태훈"));
        System.out.println(map.get("정해성"));
        System.out.println(map.get("하찬희"));
        System.out.println(map.get("박도아"));
        System.out.println(map.get("유경준"));
        System.out.println(map.get("고다니엘"));
        System.out.println(map.get("하이안"));
        System.out.println(map.get("고유호"));
        System.out.println(map.get("전민찬"));
        System.out.println(map.get("배강"));
        System.out.println(map.get("유서이"));
        System.out.println(map.get("황도빈"));
        System.out.println(map.get("강규진"));
        System.out.println(map.get("임예린"));
        System.out.println(map.get("양예온"));
        System.out.println(map.get("곽윤재"));
        System.out.println(map.get("한단"));
        System.out.println(map.get("박강현"));
        System.out.println(map.get("윤성민"));
        System.out.println(map.get("박재윤"));
        System.out.println(map.get("서현준"));
        System.out.println(map.get("노유주"));
        System.out.println(map.get("전율"));
        System.out.println(map.get("노아린"));
        System.out.println(map.get("권아윤"));
        System.out.println(map.get("송태서"));
        System.out.println(map.get("정라온"));
        System.out.println(map.get("서서한"));
        System.out.println(map.get("문주호"));
        System.out.println(map.get("오세아"));
        System.out.println(map.get("이호영"));
        System.out.println(map.get("손윤아"));
        System.out.println(map.get("이동우"));
        System.out.println(map.get("남혜준"));
        System.out.println(map.get("황솔"));
        System.out.println(map.get("권은재"));
        System.out.println(map.get("곽준휘"));
        System.out.println(map.get("양시현"));
        System.out.println(map.get("김지훈"));
        System.out.println(map.get("신서아"));
        System.out.println(map.get("노도형"));
        System.out.println(map.get("허선"));
        System.out.println(map.get("노지아"));
        System.out.println(map.get("신아인"));
        System.out.println(map.get("양시은"));
        System.out.println(map.get("노석현"));
        System.out.println(map.get("손강준"));
        System.out.println(map.get("백주안"));
        System.out.println(map.get("강단우"));
        System.out.println(map.get("오나은"));
        System.out.println(map.get("오한겸"));
        System.out.println(map.get("백예준"));
        System.out.println(map.get("노은우"));
        System.out.println(map.get("손도헌"));
        System.out.println(map.get("전진우"));
        System.out.println(map.get("안주하"));
        System.out.println(map.get("백다은"));
        System.out.println(map.get("유민기"));
        System.out.println(map.get("노휘"));
        System.out.println(map.get("박채원"));
        System.out.println(map.get("강다겸"));
        System.out.println(map.get("신여준"));
        System.out.println(map.get("허은유"));
        System.out.println(map.get("심서후"));
        System.out.println(map.get("유준이"));
        System.out.println(map.get("전민승"));
        System.out.println(map.get("강예은"));
        System.out.println(map.get("허로이"));
        System.out.println(map.get("유유진"));
        System.out.println(map.get("권건하"));
        System.out.println(map.get("하도이"));
        System.out.println(map.get("노도원"));
        System.out.println(map.get("문하성"));
        System.out.println(map.get("오시후"));
        System.out.println(map.get("이로윤"));
        System.out.println(map.get("노지후"));
        System.out.println(map.get("권채이"));
        System.out.println(map.get("전담"));
        System.out.println(map.get("하태율"));
        System.out.println(map.get("노다율"));
